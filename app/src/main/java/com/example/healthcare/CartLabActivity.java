                ...
                db.moveCartToOrder(userId, list, new Database.DatabaseCallback() {
                    ...
                    public void onSuccess() {
                        db.clearCart(userId, new Database.DatabaseCallback() {
                            @Override
                            public void onSuccess() {
                                Toast.makeText(CartLabActivity.this, "Pemesanan berhasil dan keranjang kosong!", Toast.LENGTH_LONG).show();
                                list.clear();
                                displayCartData(0);
                            }
                            ...
                            public void onFailure(Exception e) {
                                Toast.makeText(CartLabActivity.this, "Gagal menghapus keranjang setelah checkout: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    ...
                    @Override
                    public void onFailure(Exception e) {
                        Toast.makeText(CartLabActivity.this, "Failed to move cart to order: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
